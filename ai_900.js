...
function handleCheckpointClick(limit, index) {
    ...
    document.querySelector('.question img').src = `/img/ia_900/pergunta_${currentQuestion}.jpg`;
    document.querySelector('.question img').alt = `Pergunta ${currentQuestion}`;
    document.querySelector('.answers img').src = `/img/ia_900/resposta_${currentQuestion}.jpg`;
...
const totalQuestions = 102; // Altere para o número total de perguntas
...
function navigateQuestion(direction) {
    ...
    questionElement.querySelector('img').src = `/img/ia_900/pergunta_${currentQuestion}.jpg`;
    questionElement.querySelector('img').alt = `Pergunta ${currentQuestion}`;
    answersElement.querySelector('img').src = `/img/ia_900/resposta_${currentQuestion}.jpg`;
